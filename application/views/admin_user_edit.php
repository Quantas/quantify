 ...
 */
?>
<?php echo form_open('admin/editUserSave'); ?>
<?php echo validation_errors('<p class="error">','</p>'); 
      echo form_hidden('user_id', $user->getUserId());
?>
<table id="admin-config">
    <tr>
        <th colspan="2">
            Edit <?php echo $user->getUserName(); ?>
        </th>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <?php
                ...
                {
                    if($permission->getPermissionId() == $user->getPermission()->getPermissionId())
                    {
                        echo '<option value="' . $permission->getPermissionId() . '" SELECTED>' . $permission->getPermissionName() . '</option>';
                    }
                    else
                    {
